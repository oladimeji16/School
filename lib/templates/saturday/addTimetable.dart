...
class AddSaturdayTimetable extends StatefulWidget {
  @override
  _AddSaturdayTimetableState createState() => _AddSaturdayTimetableState();
}

class _AddSaturdayTimetableState extends State<AddSaturdayTimetable> {
                  ...
                  RaisedButton(
                    ...
                    onPressed: () async {
                      ...
                      if(_formKey.currentState.validate()) {
                        ...
                        await db.collection('userData').document(uid).collection('saturday').add(data.toJson());
                      }
