...
class AddWednesdayTimetable extends StatefulWidget {
  @override
  _AddWednesdayTimetableState createState() => _AddWednesdayTimetableState();
}

class _AddWednesdayTimetableState extends State<AddWednesdayTimetable> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Add a New Course', style: TextStyle(fontSize: 22.0, color: Colors.white, fontWeight: FontWeight.bold,),),
        centerTitle: true,
      ),
      body: Center(
        child: Form(
                  ...
                  RaisedButton(
                    ...
                    onPressed: () async {
                      ...
                      if(_formKey.currentState.validate()) {
                        ...
                        await db.collection('userData').document(uid).collection('wednesday').add(data.toJson());
                      }
