...
class AddTuesdayTimetable extends StatefulWidget {
  @override
  _AddTuesdayTimetableState createState() => _AddTuesdayTimetableState();
}

class _AddTuesdayTimetableState extends State<AddTuesdayTimetable> {
                  ...
                  RaisedButton(
                    ...
                    onPressed: () async {
                      ...
                      if(_formKey.currentState.validate()) {
                        ...
                        await db.collection('userData').document(uid).collection('tuesday').add(data.toJson());
                      }
