...
class AddFridayTimetable extends StatefulWidget {
  @override
  _AddFridayTimetableState createState() => _AddFridayTimetableState();
}

class _AddFridayTimetableState extends State<AddFridayTimetable> {
                  ...
                  RaisedButton(
                    ...
                    onPressed: () async {
                      ...
                      if(_formKey.currentState.validate()) {
                        ...
                        await db.collection('userData').document(uid).collection('friday').add(data.toJson());
                      }
